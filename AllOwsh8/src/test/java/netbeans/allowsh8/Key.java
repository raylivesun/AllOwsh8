...
interface Key extends Comparable<Key>, Examinable, Namespaced, Keyed {
    ...
    default @NotNull String examinableName() {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'examinableName'");
    }

    @Override
    default <R> @NotNull R examine(@NotNull Examiner<R> examiner) {
        //  Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'examine'");
    }
