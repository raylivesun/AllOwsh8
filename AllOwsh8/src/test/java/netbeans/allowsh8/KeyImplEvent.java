...
final class KeyImplEvent implements Key {
    ...
    public static Comparator<? super Key> getComparator() {
        return COMPARATOR;
    }
    public static String getNamespacePattern() {
    ...
    private final KeyImpl outer;

    public KeyImplEvent(KeyImpl outer) {
        this.outer = outer;
    }
